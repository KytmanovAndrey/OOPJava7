...
---
Реализована архитектура MVC. Калькулятор использует шаблон проектирования "Фабричный метод", который увеличивает возможности для расширения программы в дальнейшем.
Логирование реализовано с помощью паттерна "Декоратор".